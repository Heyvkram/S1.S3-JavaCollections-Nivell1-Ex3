...
## SPRINT 1 TASK 3 - Java Collections LVL 1 - EXERCISE 3
...
## How to run it
Clone the repository or download the zip file and run it in your favorite IDE.# S1.S3-JavaCollections-Nivell1-Ex3
